  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16">
      <div className="max-w-5xl mx-auto px-4 py-6">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center text-[#0b1743] hover:text-[#0053f0] transition mb-4"
        >
      ...
      <div className="mb-12 text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-[#0b1743]">Récapitulatif de la réservation</h1>
      ...
      <motion.div
        ...
        className="bg-white rounded-3xl p-6 md:p-12 shadow space-y-10"
      >
        {/* Forfait et créneau */}
        <div className="grid md:grid-cols-2 gap-6">
          {/* Forfait sélectionné */}
          <div>
            <h2 className="text-xl font-semibold text-gray-700 mb-4">Forfait sélectionné</h2>
          ...
          {/* Créneau sélectionné */}
          <div>
            <h2 className="text-xl font-semibold text-gray-700 mb-4">Créneau sélectionné</h2>
            <div className="relative rounded-xl p-6 bg-white shadow hover:shadow-lg transition">
              <div className="absolute top-4 right-4 w-5 h-5 border-2 rounded-full flex items-center justify-center border-[#0053f0]">
                <div className="w-2 h-2 bg-[#0053f0] rounded-full"></div>
              </div>
      ...
      {/* Modal succès */}
      {successModal && (
        <div className="fixed top-0 left-0 w-full h-full bg-black/20 backdrop-blur-sm flex items-center justify-center z-50">
